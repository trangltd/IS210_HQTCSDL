 ...
 * @author asus
 */
public class TraCuuHoaDon_NV extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        setTitle("Tra cứu hóa đơn của nhân viên");
        setResizable(false);
    ...
    public static void main(String args) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(TraCuuHoaDon_NV.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new TraCuuHoaDon_NV(args).setVisible(true);
            }
        });
    }
