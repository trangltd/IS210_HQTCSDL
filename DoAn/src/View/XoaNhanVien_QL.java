 ...
 * @author asus
 */
public class XoaNhanVien_QL extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jLabel12.setIcon(new javax.swing.ImageIcon(getClass().getResource("/ImageText/tag/Quản lý.png"))); // NOI18N
    ...
    public static void main(String args) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(XoaNhanVien_QL.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new XoaNhanVien_QL(args).setVisible(true);
            }
        });
    }
