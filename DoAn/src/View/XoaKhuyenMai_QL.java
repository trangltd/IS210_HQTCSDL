 ...
 * @author asus
 */
public class XoaKhuyenMai_QL extends javax.swing.JFrame {

    /**
     * Creates new form XoaKhuyenMai_QL
     */
    String user, maKM;
    public XoaKhuyenMai_QL(String a) throws HeadlessException {
        initComponents();
    ...
    private void jTable1MouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jTable1MouseClicked
        ...
        maKM = model.getValueAt(rowSelected, 0).toString();
    ...
    public static void main(String args) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(XoaKhuyenMai_QL.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            ...
            public void run() {
                new XoaKhuyenMai_QL(args).setVisible(true);
            }
        });
    }
