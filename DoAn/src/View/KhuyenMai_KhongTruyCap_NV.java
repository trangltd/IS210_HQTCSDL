 ...
 * @author asus
 */
public class KhuyenMai_KhongTruyCap_NV extends javax.swing.JFrame {

    /** Creates new form NhanVien_KhongTruyCap_KM */
    String user;
    public KhuyenMai_KhongTruyCap_NV(String a) throws HeadlessException {
        initComponents();
    ...
    private void initComponents() {
        ...
        setTitle("Khuyến mãi - Nhân viên không truy cập được");
        setResizable(false);
        ...
        jLabel10.setIcon(new javax.swing.ImageIcon(getClass().getResource("/ImageText/tag/Đăng xuất.png"))); // NOI18N
    ...
    public static void main(String args) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(KhuyenMai_KhongTruyCap_NV.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new KhuyenMai_KhongTruyCap_NV(args).setVisible(true);
            }
        });
    }
