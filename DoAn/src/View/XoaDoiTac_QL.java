 ...
 * @author asus
 */
public class XoaDoiTac_QL extends javax.swing.JFrame {

    /**
     * Creates new form XoaDoiTac_QL
     */
    String user, maDT;
    public XoaDoiTac_QL(String a) throws HeadlessException{
        initComponents();
    ...
    private void DelActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_DelActionPerformed
        ...
        if (maDT == null) {
            JOptionPane.showMessageDialog(this, "bạn chưa chọn đối tác để xóa!", "Lỗi", JOptionPane.ERROR_MESSAGE);
            return;
        }
    ...
    private void jTable1MouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jTable1MouseClicked
        ...
        maDT = model.getValueAt(rowSelected, 0).toString();
    ...
    public static void main(String args) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(XoaDoiTac_QL.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new XoaDoiTac_QL(args).setVisible(true);
            }
        });
    }
