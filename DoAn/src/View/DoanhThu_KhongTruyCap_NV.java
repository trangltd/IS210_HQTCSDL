 ...
 * @author asus
 */
public class DoanhThu_KhongTruyCap_NV extends javax.swing.JFrame {

    /**
     * Creates new form DoanhThu_KhongTruyCap_NV
     */
    String user;
    public DoanhThu_KhongTruyCap_NV(String a) throws HeadlessException{
        initComponents();
    ...
    private void initComponents() {
        ...
        setTitle("Doanh thu - Nhân viên không truy cập được");
        setResizable(false);
    ...
    public static void main(String args) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(DoanhThu_KhongTruyCap_NV.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new DoanhThu_KhongTruyCap_NV(args).setVisible(true);
            }
        });
    }
