 ...
 * @author asus
 */
public class KhachHang_KhongTruyCap_NV extends javax.swing.JFrame {

    /**
     * Creates new form KhachHang_KhongTruyCap_NV
     */
    String user;
    public KhachHang_KhongTruyCap_NV(String a) throws HeadlessException {
        initComponents();
    ...
    private void initComponents() {
        ...
        setTitle("Khách hàng - Nhân viên không truy cập được");
        setResizable(false);
        ...
        jLabel7.setIcon(new javax.swing.ImageIcon(getClass().getResource("/ImageText/tag/Đăng xuất.png"))); // NOI18N
    ...
    public static void main(String args) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(KhachHang_KhongTruyCap_NV.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new KhachHang_KhongTruyCap_NV(args).setVisible(true);
            }
        });
    }
