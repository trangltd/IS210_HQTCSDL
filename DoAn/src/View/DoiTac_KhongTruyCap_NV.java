 ...
 * @author asus
 */
public class DoiTac_KhongTruyCap_NV extends javax.swing.JFrame {

    /**
     * Creates new form DoiTac_KhongTruyCap_NV
     */
    String user;
    public DoiTac_KhongTruyCap_NV(String a) throws HeadlessException{
        initComponents();
    ...
    private void initComponents() {
        ...
        setTitle("Đối tác - Nhân viên không truy cập được");
        setResizable(false);
    ...
    public static void main(String args) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(DoiTac_KhongTruyCap_NV.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new DoiTac_KhongTruyCap_NV(args).setVisible(true);
            }
        });
    }
