 ...
 * @author asus
 */
public class TraCuuHoaDon extends javax.swing.JFrame {
    ...
    String user;
    int soHD;
    public TraCuuHoaDon(String a) throws HeadlessException{
        initComponents();
    ...
    private void initComponents() {
        ...
        Add1.setBackground(new java.awt.Color(196, 100, 96));
    ...
    public static void main(String args) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(TraCuuHoaDon.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new TraCuuHoaDon(args).setVisible(true);
            }
        });
    }
