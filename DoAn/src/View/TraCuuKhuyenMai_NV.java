 ...
 * @author asus
 */
public class TraCuuKhuyenMai_NV extends javax.swing.JFrame {

    /**
     * Creates new form TraCuuKhuyenMai_NV
     */
    String user;
    public TraCuuKhuyenMai_NV(String a) throws HeadlessException {
        initComponents();
    ...
    private void initComponents() {
        ...
        setTitle("Tra cứu khuyến mãi của nhân viên");
        setResizable(false);
    ...
    public static void main(String args) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(TraCuuKhuyenMai_NV.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new TraCuuKhuyenMai_NV(args).setVisible(true);
            }
        });
    }
